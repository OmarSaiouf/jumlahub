...
use App\Modules\Admin\Http\Requests\CurrencyRequest;
...
class CurrencyCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Modules\Admin\Models\Currency::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/currency');
        CRUD::setEntityNameStrings(__('currency'), __('currencies'));
    }
